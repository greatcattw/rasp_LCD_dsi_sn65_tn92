...
static void sn65_tn92_init_sequence(struct mipi_dsi_device *dsi) {
}
...
static const struct drm_display_mode sn65_tn92_mode = {
    .clock = 33000,

    .hdisplay = 800,
    .hsync_start = 800 + /* HFP */ 10,
    .hsync_end = 800 + 10 + /* HSync */ 4,
    .htotal = 800 + 10 + 4 + /* HBP */ 20,

    .vdisplay = 480,
    .vsync_start = 480 + /* VFP */ 8,
    .vsync_end = 480 + 8 + /* VSync */ 4,
    .vtotal = 480 + 8 + 4 + /* VBP */ 14,
...
static const struct dsi_panel_desc sn65_tn92_desc = {
    .mode = &sn65_tn92_mode,
    .lanes = 1,
    .flags =
        MIPI_DSI_MODE_VIDEO | MIPI_DSI_MODE_VIDEO_BURST | MIPI_DSI_MODE_LPM,
    .format = MIPI_DSI_FMT_RGB888,
    .init_sequence = sn65_tn92_init_sequence};
...
static const struct of_device_id dsi_panel_of_match[] = {
    {.compatible = "gcat,sn65_tn92", .data = &sn65_tn92_desc},	
...
MODULE_DESCRIPTION("Raspberry Pi DSI Panels Driver for sn65_tn92");
MODULE_LICENSE("GPL");
